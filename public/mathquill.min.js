...
!(function () {
  ...
  function c(e) {
    function n(t) {
      var e, n;
      return t && t.nodeType
        ? ((e = x(t).children('.mq-root-block').attr(Rt)),
  ...
  function p(t, e) {
    (t.jQadd = function () {
      ...
      (t.reflow = function () {
        ...
        X(this.delimjQs, zt(1 + 0.2 * (t - 1), 1.2), 1.2 * t);
      });
  }
  function d(t, e) {
    var e = e || t,
      n = dt[t],
      s = dt[e];
    (T[t] = i(pt, w, t, n, e, s)), (T[n] = i(pt, q, t, n, e, s));
  }
  var m,
    g,
    b,
    ...
    Lt,
    At = window.jQuery,
    It = 'mathquill-command-id',
    Rt = 'mathquill-block-id',
    zt = Math.min,
    Mt = Math.max;
  ...
  (g = [].slice),
    ...
    (M = (function () {
      ...
      return function (n, i) {
        ...
        function u(t) {
          t.target === q[0] && (v && w && l(), (w = t), s(f));
        }
        function h(t) {
          t.target === q[0] && v && !w && s(f);
        }
        function f() {
          if (!a()) {
            var t = q.val();
    ...
    C.open(function (t) {
      t.seek = function (t, e, n) {
        ...
        return (
          t &&
            ((i = t.attr(Rt) || t.attr(It)) ||
              ((r = t.parent()), (i = r.attr(Rt) || r.attr(It)))),
    ...
    C.open(function (t) {
      (S.p.substituteTextarea = function () {
        ...
        (S.p.substituteKeyboardEvents = M),
          ...
          for (var e, n = 0, i = [[this, n]]; i.length; )
            (e = i.shift()),
              e[0].children().each(function (s) {
                var r = s instanceof H ? 1 : 0;
                (n = e[1] + r),
                  n <= t ? i.push([s, n]) : (r ? s.children() : s).remove();
              });
        });
    })),
    ($ = v(N, function (t, e) {
      ...
      (t.join = function (t) {
        ...
        (t.writeLatex = function (t, e) {
          ...
          r &&
            ...
            (r.children().adopt(t.parent, t[w], t[q]),
            (n = r.jQize()),
            n.insertBefore(t.jQ),
            (t[w] = r.ends[q]),
            r.finalizeInsert(t.options, t),
            r.ends[q][q].siblingCreated &&
              r.ends[q][q].siblingCreated(t.options, w),
            r.ends[w][w].siblingCreated &&
              r.ends[w][w].siblingCreated(t.options, q),
      ...
      (t.ctrlSeq = '\\text'),
        ...
        (t.createLeftOf = function (t) {
          var n,
            i = this;
          if (
            (e.createLeftOf.call(this, t), t.insAtRightEnd(i), i.replacedText)
          )
    ...
    (Q.em = Q.italic = Q.italics = Q.emph = Q.textit = Q.textsl = h(
      '\\textit',
      'i',
      'class="mq-text-mode"'
    )),
    ...
    (Y = v(V, function (t, e) {
      (t.keystroke = function (t) {
        ...
        (t.write = function (t, e) {
          if ((t.show().deleteSelection(), '$' === e)) Z(t).createLeftOf(t);
          else {
            var n;
            '<' === e ? (n = '&lt;') : '>' === e && (n = '&gt;'),
  ...
  it
    ...
    (Q.subscript = Q._ = v(ot, function (t, e) {
      (t.supsub = 'sub'),
        (t.htmlTemplate =
    ...
    (Q.superscript = Q.supscript = Q['^'] = v(ot, function (t, e) {
      (t.supsub = 'sup'),
        (t.htmlTemplate =
        ...
        (t.createLeftOf = function (t) {
          e.createLeftOf.apply(this, arguments),
            t.options.sumStartsWithNEquals &&
              (wt('n').createLeftOf(t), St().createLeftOf(t));
        }),
        (t.latex = function () {
          function t(t) {
    ...
    (Q['∫'] = Q.int = Q.integral = v(at, function (t, e) {
      (t.init = function () {
    ...
    (lt = Q.frac = Q.dfrac = Q.cfrac = Q.fraction = v($, function (t, e) {
      (t.ctrlSeq = '\\frac'),
        (t.htmlTemplate =
    ...
    (Q.vec = i(ft, '\\vec', '&rarr;', ['vec(', ')'])),
    (Q.tilde = i(ft, '\\tilde', '~', ['tilde(', ')'])),
    ...
    (Q.right = v($, function (t) {
      t.parser = function () {
        return B.fail('unmatched \\right');
      };
    })),
    (mt = Q.binom = Q.binomial = v(v($, p), function (t, e) {
      (t.ctrlSeq = '\\binom'),
        (t.htmlTemplate =
    ...
    (Q.editable = Q.MathQuillMathField = v($, function (t, e) {
    ...
    (Q.notin = Q.cong = Q.equiv = Q.oplus = Q.otimes = v(U, function (t, e) {
      t.init = function (t) {
        e.init.call(this, '\\' + t + ' ', '&' + t + ';');
      };
    })),
    (Q['≠'] = Q.ne = Q.neq = i(U, '\\ne ', '&ne;')),
    (Q['∗'] = Q.ast = Q.star = Q.loast = Q.lowast = i(U, '\\ast ', '&lowast;')),
    (Q.therefor = Q.therefore = i(U, '\\therefore ', '&there4;')),
    (Q.cuz = Q.because = i(U, '\\because ', '&#8757;')),
    (Q.prop = Q.propto = i(U, '\\propto ', '&prop;')),
    (Q['≈'] = Q.asymp = Q.approx = i(U, '\\approx ', '&asymp;')),
    (Q.isin = Q.in = i(U, '\\in ', '&isin;')),
    (Q.ni = Q.contains = i(U, '\\ni ', '&ni;')),
    (Q.notni = Q.niton = Q.notcontains = Q.doesnotcontain = i(
      U,
      '\\not\\ni ',
      '&#8716;'
    )),
    (Q.sub = Q.subset = i(U, '\\subset ', '&sub;')),
    (Q.sup = Q.supset = Q.superset = i(U, '\\supset ', '&sup;')),
    (Q.nsub = Q.notsub = Q.nsubset = Q.notsubset = i(
      U,
      '\\not\\subset ',
      '&#8836;'
    )),
    (Q.nsup = Q.notsup = Q.nsupset = Q.notsupset = Q.nsuperset = Q.notsuperset = i(
      U,
      '\\not\\supset ',
      '&#8837;'
    )),
    (Q.sube = Q.subeq = Q.subsete = Q.subseteq = i(U, '\\subseteq ', '&sube;')),
    (Q.supe = Q.supeq = Q.supsete = Q.supseteq = Q.supersete = Q.superseteq = i(
      U,
      '\\supseteq ',
      '&supe;'
    )),
    (Q.nsube = Q.nsubeq = Q.notsube = Q.notsubeq = Q.nsubsete = Q.nsubseteq = Q.notsubsete = Q.notsubseteq = i(
      U,
      '\\not\\subseteq ',
      '&#8840;'
    )),
    (Q.nsupe = Q.nsupeq = Q.notsupe = Q.notsupeq = Q.nsupsete = Q.nsupseteq = Q.notsupsete = Q.notsupseteq = Q.nsupersete = Q.nsuperseteq = Q.notsupersete = Q.notsuperseteq = i(
      U,
      '\\not\\supseteq ',
      '&#8841;'
    )),
    (Q.mathbb = v($, function (e) {
      (e.createLeftOf = t),
        (e.numBlocks = function () {
          return 1;
        }),
    ...
    (Q.N = Q.naturals = Q.Naturals = i(W, '\\mathbb{N}', '&#8469;')),
    (Q.P = Q.primes = Q.Primes = Q.projective = Q.Projective = Q.probability = Q.Probability = i(
      W,
      '\\mathbb{P}',
      '&#8473;'
    )),
    (Q.Z = Q.integers = Q.Integers = i(W, '\\mathbb{Z}', '&#8484;')),
    (Q.Q = Q.rationals = Q.Rationals = i(W, '\\mathbb{Q}', '&#8474;')),
    (Q.R = Q.reals = Q.Reals = i(W, '\\mathbb{R}', '&#8477;')),
    (Q.C = Q.complex = Q.Complex = Q.complexes = Q.Complexes = Q.complexplane = Q.Complexplane = Q.ComplexPlane = i(
      W,
      '\\mathbb{C}',
      '&#8450;'
    )),
    (Q.H = Q.Hamiltonian = Q.quaternions = Q.Quaternions = i(
      W,
      '\\mathbb{H}',
      '&#8461;'
    )),
    (Q.quad = Q.emsp = i(W, '\\quad ', '    ')),
    (Q.qquad = i(W, '\\qquad ', '        ')),
    (Q.diamond = i(W, '\\diamond ', '&#9671;')),
    (Q.bigtriangleup = i(W, '\\bigtriangleup ', '&#9651;')),
    (Q.ominus = i(W, '\\ominus ', '&#8854;')),
    (Q.uplus = i(W, '\\uplus ', '&#8846;')),
    (Q.bigtriangledown = i(W, '\\bigtriangledown ', '&#9661;')),
    (Q.sqcap = i(W, '\\sqcap ', '&#8851;')),
    (Q.triangleleft = i(W, '\\triangleleft ', '&#8882;')),
    (Q.sqcup = i(W, '\\sqcup ', '&#8852;')),
    (Q.triangleright = i(W, '\\triangleright ', '&#8883;')),
    (Q.odot = Q.circledot = i(W, '\\odot ', '&#8857;')),
    (Q.bigcirc = i(W, '\\bigcirc ', '&#9711;')),
    (Q.dagger = i(W, '\\dagger ', '&#0134;')),
    (Q.ddagger = i(W, '\\ddagger ', '&#135;')),
    (Q.wr = i(W, '\\wr ', '&#8768;')),
    (Q.amalg = i(W, '\\amalg ', '&#8720;')),
    (Q.models = i(W, '\\models ', '&#8872;')),
    (Q.prec = i(W, '\\prec ', '&#8826;')),
    ...
    (Q.ll = i(W, '\\ll ', '&#8810;')),
    (Q.gg = i(W, '\\gg ', '&#8811;')),
    (Q.parallel = i(W, '\\parallel ', '&#8741;')),
    (Q.nparallel = i(W, '\\nparallel ', '&#8742;')),
    (Q.bowtie = i(W, '\\bowtie ', '&#8904;')),
    (Q.sqsubset = i(W, '\\sqsubset ', '&#8847;')),
    (Q.sqsupset = i(W, '\\sqsupset ', '&#8848;')),
    (Q.smile = i(W, '\\smile ', '&#8995;')),
    (Q.sqsubseteq = i(W, '\\sqsubseteq ', '&#8849;')),
    (Q.sqsupseteq = i(W, '\\sqsupseteq ', '&#8850;')),
    (Q.doteq = i(W, '\\doteq ', '&#8784;')),
    (Q.frown = i(W, '\\frown ', '&#8994;')),
    (Q.vdash = i(W, '\\vdash ', '&#8870;')),
    (Q.dashv = i(W, '\\dashv ', '&#8867;')),
    (Q.nless = i(W, '\\nless ', '&#8814;')),
    (Q.ngtr = i(W, '\\ngtr ', '&#8815;')),
    (Q.longleftarrow = i(W, '\\longleftarrow ', '&#8592;')),
    (Q.longrightarrow = i(W, '\\longrightarrow ', '&#8594;')),
    (Q.Longleftarrow = i(W, '\\Longleftarrow ', '&#8656;')),
    (Q.Longrightarrow = i(W, '\\Longrightarrow ', '&#8658;')),
    (Q.longleftrightarrow = i(W, '\\longleftrightarrow ', '&#8596;')),
    (Q.updownarrow = i(W, '\\updownarrow ', '&#8597;')),
    (Q.Longleftrightarrow = i(W, '\\Longleftrightarrow ', '&#8660;')),
    (Q.Updownarrow = i(W, '\\Updownarrow ', '&#8661;')),
    (Q.mapsto = i(W, '\\mapsto ', '&#8614;')),
    (Q.nearrow = i(W, '\\nearrow ', '&#8599;')),
    (Q.hookleftarrow = i(W, '\\hookleftarrow ', '&#8617;')),
    (Q.hookrightarrow = i(W, '\\hookrightarrow ', '&#8618;')),
    (Q.searrow = i(W, '\\searrow ', '&#8600;')),
    (Q.leftharpoonup = i(W, '\\leftharpoonup ', '&#8636;')),
    (Q.rightharpoonup = i(W, '\\rightharpoonup ', '&#8640;')),
    (Q.swarrow = i(W, '\\swarrow ', '&#8601;')),
    (Q.leftharpoondown = i(W, '\\leftharpoondown ', '&#8637;')),
    (Q.rightharpoondown = i(W, '\\rightharpoondown ', '&#8641;')),
    (Q.nwarrow = i(W, '\\nwarrow ', '&#8598;')),
    (Q.ldots = i(W, '\\ldots ', '&#8230;')),
    (Q.cdots = i(W, '\\cdots ', '&#8943;')),
    (Q.vdots = i(W, '\\vdots ', '&#8942;')),
    ...
    (Q.wp = i(W, '\\wp ', '&#8472;')),
    (Q.bot = i(W, '\\bot ', '&#8869;')),
    (Q.clubsuit = i(W, '\\clubsuit ', '&#9827;')),
    (Q.diamondsuit = i(W, '\\diamondsuit ', '&#9826;')),
    (Q.heartsuit = i(W, '\\heartsuit ', '&#9825;')),
    (Q.spadesuit = i(W, '\\spadesuit ', '&#9824;')),
    (Q.parallelogram = i(W, '\\parallelogram ', '&#9649;')),
    (Q.square = i(W, '\\square ', '&#11036;')),
    (Q.oint = i(W, '\\oint ', '&#8750;')),
    (Q.bigcap = i(W, '\\bigcap ', '&#8745;')),
    (Q.bigcup = i(W, '\\bigcup ', '&#8746;')),
    (Q.bigsqcup = i(W, '\\bigsqcup ', '&#8852;')),
    (Q.bigvee = i(W, '\\bigvee ', '&#8744;')),
    (Q.bigwedge = i(W, '\\bigwedge ', '&#8743;')),
    (Q.bigodot = i(W, '\\bigodot ', '&#8857;')),
    (Q.bigotimes = i(W, '\\bigotimes ', '&#8855;')),
    (Q.bigoplus = i(W, '\\bigoplus ', '&#8853;')),
    (Q.biguplus = i(W, '\\biguplus ', '&#8846;')),
    (Q.lfloor = i(W, '\\lfloor ', '&#8970;')),
    (Q.rfloor = i(W, '\\rfloor ', '&#8971;')),
    (Q.lceil = i(W, '\\lceil ', '&#8968;')),
    (Q.rceil = i(W, '\\rceil ', '&#8969;')),
    (Q.opencurlybrace = Q.lbrace = i(W, '\\lbrace ', '{')),
    (Q.closecurlybrace = Q.rbrace = i(W, '\\rbrace ', '}')),
    (Q.lbrack = i(W, '[')),
    (Q.rbrack = i(W, ']')),
    (Q.slash = i(W, '/')),
    (Q.vert = i(W, '|')),
    (Q.perp = Q.perpendicular = i(W, '\\perp ', '&perp;')),
    (Q.nabla = Q.del = i(W, '\\nabla ', '&nabla;')),
    (Q.hbar = i(W, '\\hbar ', '&#8463;')),
    (Q.AA = Q.Angstrom = Q.angstrom = i(W, '\\text\\AA ', '&#8491;')),
    (Q.ring = Q.circ = Q.circle = i(W, '\\circ ', '&#8728;')),
    (Q.bull = Q.bullet = i(W, '\\bullet ', '&bull;')),
    (Q.setminus = Q.smallsetminus = i(W, '\\setminus ', '&#8726;')),
    (Q.not = Q['¬'] = Q.neg = i(W, '\\neg ', '&not;')),
    (Q['…'] = Q.dots = Q.ellip = Q.hellip = Q.ellipsis = Q.hellipsis = i(
      W,
      '\\dots ',
      '&hellip;'
    )),
    (Q.converges = Q.darr = Q.dnarr = Q.dnarrow = Q.downarrow = i(
      W,
      '\\downarrow ',
      '&darr;'
    )),
    (Q.dArr = Q.dnArr = Q.dnArrow = Q.Downarrow = i(
      W,
      '\\Downarrow ',
      '&dArr;'
    )),
    (Q.diverges = Q.uarr = Q.uparrow = i(W, '\\uparrow ', '&uarr;')),
    (Q.uArr = Q.Uparrow = i(W, '\\Uparrow ', '&uArr;')),
    (Q.to = i(U, '\\to ', '&rarr;')),
    (Q.rarr = Q.rightarrow = i(W, '\\rightarrow ', '&rarr;')),
    (Q.implies = i(U, '\\Rightarrow ', '&rArr;')),
    (Q.rArr = Q.Rightarrow = i(W, '\\Rightarrow ', '&rArr;')),
    (Q.gets = i(U, '\\gets ', '&larr;')),
    (Q.larr = Q.leftarrow = i(W, '\\leftarrow ', '&larr;')),
    (Q.impliedby = i(U, '\\Leftarrow ', '&lArr;')),
    (Q.lArr = Q.Leftarrow = i(W, '\\Leftarrow ', '&lArr;')),
    (Q.harr = Q.lrarr = Q.leftrightarrow = i(W, '\\leftrightarrow ', '&harr;')),
    (Q.iff = i(U, '\\Leftrightarrow ', '&hArr;')),
    (Q.hArr = Q.lrArr = Q.Leftrightarrow = i(W, '\\Leftrightarrow ', '&hArr;')),
    (Q.Re = Q.Real = Q.real = i(W, '\\Re ', '&real;')),
    (Q.Im = Q.imag = Q.image = Q.imagin = Q.imaginary = Q.Imaginary = i(
      W,
      '\\Im ',
      '&image;'
    )),
    (Q.part = Q.partial = i(W, '\\partial ', '&part;')),
    (Q.infty = Q.infin = Q.infinity = i(W, '\\infty ', '&infin;'));
  (Q.pounds = i(W, '\\pounds ', '&pound;')),
    (Q.alef = Q.alefsym = Q.aleph = Q.alephsym = i(W, '\\aleph ', '&alefsym;')),
    (Q.xist = Q.xists = Q.exist = Q.exists = i(W, '\\exists ', '&exist;')),
    (Q.nexists = Q.nexist = i(W, '\\nexists ', '&#8708;')),
    (Q.and = Q.land = Q.wedge = i(U, '\\wedge ', '&and;')),
    (Q.or = Q.lor = Q.vee = i(U, '\\vee ', '&or;')),
    (Q.o = Q.O = Q.empty = Q.emptyset = Q.oslash = Q.Oslash = Q.nothing = Q.varnothing = i(
      U,
      '\\varnothing ',
      '&empty;'
    )),
    (Q.cup = Q.union = i(U, '\\cup ', '&cup;')),
    (Q.cap = Q.intersect = Q.intersection = i(U, '\\cap ', '&cap;')),
    (Q.deg = Q.degree = i(W, '\\degree ', '&deg;')),
    (Q.ang = Q.angle = i(W, '\\angle ', '&ang;')),
    (Q.measuredangle = i(W, '\\measuredangle ', '&#8737;')),
    (bt = v(W, function (t, e) {
      t.createLeftOf = function (t) {
    ...
    (qt = {}),
    (xt = S.p.autoOperatorNames = { _maxLength: 9 }),
  ...
  (Q.operatorname = v($, function (e) {
    ...
    (Q[' '] = Q.space = i(W, '\\ ', '&nbsp;')),
    (Q["'"] = Q.prime = i(W, "'", '&prime;')),
    (Q['″'] = Q.dprime = i(W, '″', '&Prime;')),
    (Q.backslash = i(W, '\\backslash ', '\\')),
    T['\\'] || (T['\\'] = Q.backslash),
    (Q.$ = i(W, '\\$', '$')),
    (Qt = v(P, function (t, e) {
      t.init = function (t, n) {
    ...
    (Q['&'] = i(Qt, '\\&', '&amp;')),
    (Q['%'] = i(Qt, '\\%', '%')),
    (Q.alpha = Q.beta = Q.gamma = Q.delta = Q.zeta = Q.eta = Q.theta = Q.iota = Q.kappa = Q.mu = Q.nu = Q.xi = Q.rho = Q.sigma = Q.tau = Q.chi = Q.psi = Q.omega = v(
      vt,
      function (t, e) {
        t.init = function (t) {
          e.init.call(this, '\\' + t + ' ', '&' + t + ';');
    ...
    (Q.Upsilon = Q.Upsi = Q.upsih = Q.Upsih = i(
      P,
      '\\Upsilon ',
      '<var style="font-family: serif">&upsih;</var>'
    )),
    (Q.Gamma = Q.Delta = Q.Theta = Q.Lambda = Q.Xi = Q.Pi = Q.Sigma = Q.Phi = Q.Psi = Q.Omega = Q.forall = v(
      W,
      function (t, e) {
        t.init = function (t) {
          e.init.call(this, '\\' + t + ' ', '&' + t + ';');
    ...
    (Q['+'] = i(jt, '+', '+')),
    (Q['–'] = Q['-'] = i(jt, '-', '&minus;')),
    (Q['±'] = Q.pm = Q.plusmn = Q.plusminus = i(jt, '\\pm ', '&plusmn;')),
    (Q.mp = Q.mnplus = Q.minusplus = i(jt, '\\mp ', '&#8723;')),
    (T['*'] = Q.sdot = Q.cdot = i(U, '\\cdot ', '&middot;', '*')),
    (_t = v(U, function (t, e) {
      (t.init = function (t, n) {
    ...
    (Q['<'] = Q.lt = i(_t, Ct, !0)),
    (Q['>'] = Q.gt = i(_t, Dt, !0)),
    (Q['≤'] = Q.le = Q.leq = i(_t, Ct, !1)),
    (Q['≥'] = Q.ge = Q.geq = i(_t, Dt, !1)),
    (St = v(U, function (t, e) {
      (t.init = function () {
        e.init.call(this, '=', '=');
      }),
        (t.createLeftOf = function (t) {
          if (t[w] instanceof _t && t[w].strict)
            return t[w].swap(!1), void t[w].bubble('reflow');
          e.createLeftOf.apply(this, arguments);
        });
    })),
    (Q['='] = St),
    (Q['×'] = Q.times = i(U, '\\times ', '&times;', '[x]')),
    (Q['÷'] = Q.div = Q.divide = Q.divides = i(U, '\\div ', '&divide;', '[/]')),
    (T['~'] = Q.sim = i(U, '\\sim ', '~', '~')),
    (Et = c(1));
  for (Lt in Et)
    !(function (t, e) {
